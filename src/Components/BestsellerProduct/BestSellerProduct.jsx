        ...
        <div className='bg-white w-11/12 md:w-10/12 lg:w-full lg:h-[35rem] h-[36.5rem] mx-auto -mt-[3.5rem] md:-mt-[7rem] lg:mt-0 shadow-lg drop-shadow-md relative'>
            <div className='px-[37px] py-[46px] lg:px-[76px] lg:pt-[60px] lg:pb-[20px]  lg:space-y-4'>
                <div className='special_offer flex justify-start gap-4 items-center'>
                    <p className='text-black text-[14px] font-[400] tracking-wider uppercase md:text-[16px] lg:text-[1.3rem]'>Special Offer</p>
                ...
                <div className='flex items-center justify-start gap-5 pt-6 lg:pt-0'>
                    <svg xmlns="http://www.w3.org/2000/svg" className='' width="110" height="30" viewBox="0 0 101 20" fill="none">
