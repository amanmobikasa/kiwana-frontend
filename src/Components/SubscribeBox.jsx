...
const SubscribeBox = () => {
    ...
    <section className='w-12/12  h-[25rem] md:h-[30rem] lg:h-[20rem]  overflow-hidden bg-[#FBFBFB] relative '>
        ...
        <form className='w-11/12 lg:w-[35%] relative mx-auto flex flex-col space-y-4 md:space-y-8 lg:space-y-5 h-fit items-center mt-[1.5rem] lg:pt-[2rem]'>
            ...
            <label className='flex justify-self-start gap-4 w-11/12 items-start lg:w-10/12 lg:mx-auto' htmlFor='confirm'>
                <input id="confirm" type='checkbox' className='mt-1 md:m-0 h-[22px] w-[22px] md:h-[24px] md:w-[24px] lg:w-[22px] lg:h-[22px] border-[0.01rem] border-nav-pink focus:accent-nav-pink ' />
