        ...
        <div className='container-inner  w-full h-fit relative'>
            ...
            <div className='content-container h-fit absolute top-[5rem] md:top-[6rem] lg:left-[10.5rem] lg:m-0 lg:top-[11.5rem] left-0 right-0 w-9/12 lg:w-4/12   m-auto  flex justify-center'>
                <div className='w-full space-y-0 md:space-y-[2rem] lg:space-y-[0rem]'>
                    <h1 className='text-white text-[30px] text-center lg:text-left font-[MonteCarlo] font-[400] md:text-[30px]  lg:tracking-wider lg:opacity-80 lg:text-[2.5rem]'>Fabulous Moments Every Day</h1>
                    <h1 className='top-[5rem]  text-white font-playfair text-center lg:text-left font-[700] text-[45px] lg:text-[58px] leading-tight tracking-wider lg:tracking-wider md:text-[55px]'>Clean <span className='font-[500]'>Beauty</span> Visible <span className='font-[500]'>Results</span></h1>
                    <div className='w-full flex justify-center pt-4 lg:justify-start lg:pt-[3.2rem]'>
                        <button className='uppercase font-poppins text-white bg-transparent px-8 lg:px-5 py-3  border-white border-[0.01rem] text-[17px] lg:text-[20px] tracking-wider hover:bg-nav-pink md:px-12 md:py-3 md:text-lg'>SHOP NOW</button>
                    </div>
                </div>
            </div>
        </div>
