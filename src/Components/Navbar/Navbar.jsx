  ...
  return (
    <>
      <nav className="bg-[#FCEBE8] w-full relative overflow-auto h-fit">
        <div className="px-[2rem] py-4 flex items-center justify-evenly">
          <div className="w-fit h-fit">
            <img src={logo} alt="logo" className="h-auto w-auto" />
          </div>
          <ul className="flex items-center gap-[30px] font-[16px] text-black">
            <li className="">
