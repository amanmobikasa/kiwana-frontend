...
<section
        id="discount_comp"
        className="w-full my-[8rem] relative overflow-hidden h-fit lg:mt-[16.5rem] lg:mb-[6rem] lg:w-11/12 lg:mx-auto"
      >
              ...
              <>
                <div key={i} className="w-11/12 md:w-10/12 mx-auto h-fit lg:h-full relative lg:flex lg:flex-row-reverse lg:bg-[#D1D9C7]">
                  ...
                  >
                    ...
                    >
                      {data.heading !== "" ? (
                        <h1 className="uppercase text-[#4E7661] font-poppins text-[20px] md:text-[18px] font-[600]">
                          New Collection
                        </h1>
                      ) : (
                        ""
                      ...
                      <h2
                        className={`text-[37px] font-[600] md:text-[45px] ${data.textColor} leading-snug md:leading-tight`}
                      >
                        {data.sub_heading}
                      </h2>
                      <button
                        className={`uppercase py-2 px-4 text-[1.1rem] md:px-7 md:py-3  tracking-widest bg-white ${data.button_style}`}
                      >
                        {data.button_text}
                      </button>
                    </div>
...
export default DiscountCompMobile;
