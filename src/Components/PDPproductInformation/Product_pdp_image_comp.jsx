                ...
                <div className='inner-container space-y-[1rem]'>
                    <div className='mx-auto  relative bg-white p-3 h-[25rem]'>
                        <div className='object-contain h-fit w-full   aspect-square'>
                            <img src={PdpImageOne} className='h-full w-full' alt="" />
                        </div>
                        <div className='absolute left-[1rem] top-[1rem] h-fit w-fit'>
                            <div>
                    ...
                    <div className='images-container w-full h-fit relative'>
                        <div className="inner-container flex justify-start gap-4">
                            <div className='object-contain h-[110px] w-[110px] border-2 focus:border-red-500 outline-gray-300 shadow-md'>
                                <img src={PdpImageOne} className='aspect-square h-full w-full' alt="" />
                            </div>
                            <div className='object-contain h-[110px] w-[110px] border-2 focus:border-red-500 outline-gray-300 shadow-md'>
                                <img src={PdpImageOne} className='aspect-square h-full w-full' alt="" />
                            </div>
