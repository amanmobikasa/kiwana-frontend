...
const LandingComponent = () => {
    ...
    <section id='landingComp' className='w-full relative overflow-hidden h-fit '>
        <div className='container-inner  w-full h-fit relative'>
            ...
            <div className='content-container absolute top-[3rem] md:top-[6rem] lg:left-[10rem] lg:m-0 lg:top-[10rem] left-0 right-0 w-8/12 lg:w-4/12  m-auto  flex justify-center'>
                <div className='w-full space-y-[1rem] md:space-y-[2rem]'>
                    <h1 className='text-white text-[25px] text-center lg:text-left font-[MonteCarlo] font-[400] md:text-[30px]  lg:tracking-widest lg:opacity-80'>Fabulous Moments Every Day</h1>
                    ...
                    <div className='w-full flex justify-center lg:justify-start'>
                        <button className='uppercase font-poppins text-white bg-transparent px-8 py-2 border-white border-[0.01rem] text-[14px] tracking-wider hover:bg-nav-pink md:px-12 md:py-3 md:text-lg'>SHOP NOW</button>
                    </div>
                </div>
            </div>
        </div>
