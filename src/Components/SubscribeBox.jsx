...
const SubscribeBox = () => {
    ...
    <section className='w-12/12  h-[25rem] md:h-[30rem] lg:h-[20rem]  overflow-hidden bg-[#FBFBFB] relative '>
        ...
        <form className='w-10/12 lg:w-[35%] relative mx-auto flex flex-col space-y-4 md:space-y-8 lg:space-y-5 h-fit items-center mt-[3rem]'>
            <h1 className='text-nav-blue text-[30px] lg:text-[30px] font-[400] text-center  md:text-[30px] lg:w-11/12'>Stay Up to Date with All News and Exclusive Offers </h1>
            <div className='lg:space-y-0 lg:w-11/12 lg:flex lg:items-center space-y-6'>
            ...
            <label className='flex justify-self-start gap-4 w-11/12 items-center lg:w-10/12 lg:mx-auto' htmlFor='confirm'>
                <input id="confirm" type='checkbox' className='mt-1 md:m-0 md:h-[24px] md:w-[24px] border-[0.01rem] border-nav-pink focus:accent-nav-pink ' />
                <p className='text-[12px] text-black md:text-[14px]'>I accept the <span className='text-nav-pink underline'>terms & conditions</span> and the <span className='text-nav-pink underline'>data protection</span></p>
            </label>
        </form> 
    </section>
    </>
